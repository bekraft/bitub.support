...
/**
 * This is the item provider adapter for a {@link bitub.support.p2.TargetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  protected void addNamePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
        getResourceLocator(), getString("_UI_TargetType_name_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_TargetType_name_feature", "_UI_TargetType_type"),
        P2Package.Literals.TARGET_TYPE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
        getResourceLocator(), getString("_UI_TargetType_sequenceNumber_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_TargetType_sequenceNumber_feature", "_UI_TargetType_type"),
        P2Package.Literals.TARGET_TYPE__SEQUENCE_NUMBER, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null,
        null));
  }
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(P2Package.Literals.TARGET_TYPE__LOCATIONS);
    }
  ...
  {
    String label = ((TargetType) object).getName();
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors
        .add(createChildParameter(P2Package.Literals.TARGET_TYPE__LOCATIONS, P2Factory.eINSTANCE.createLocationsType()));
  }
