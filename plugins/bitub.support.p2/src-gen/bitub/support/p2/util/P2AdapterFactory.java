...
public class P2AdapterFactory extends AdapterFactoryImpl
{
  ...
  protected P2Switch<Adapter> modelSwitch = new P2Switch<Adapter>() {
    ...
    @Override
    public Adapter caseIMetadataRepositoryManager(IMetadataRepositoryManager object)
    {
      return createIMetadataRepositoryManagerAdapter();
    }
    ...
    @Override
    public Adapter caseIArtifactRepositoryManager(IArtifactRepositoryManager object)
    {
      return createIArtifactRepositoryManagerAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.DocumentRoot <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.LocationsType <em>Locations Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.LocationType <em>Location Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.RepositoryType <em>Repository Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.TargetType <em>Target Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link bitub.support.p2.UnitType <em>Unit Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.equinox.p2.repository.metadata.IMetadataRepositoryManager <em>IMetadata Repository Manager</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createIMetadataRepositoryManagerAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.equinox.p2.repository.artifact.IArtifactRepositoryManager <em>IArtifact Repository Manager</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createIArtifactRepositoryManagerAdapter()
  {
    return null;
  }
